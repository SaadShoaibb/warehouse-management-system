...
const ClientsTable = ({ clients, onEditClient, onDeleteClient, onViewProducts }) => {
          ...
          <tbody className="divide-y divide-gray-700">
            {filteredClients.map((client, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">{client.phoneNumber}</td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <button
                    onClick={() => onViewProducts(client)}
